...
internal class AndroidNotificationsManager(private val notificationManager: NotificationManager,
                                                private val importanceTranslator: NutshellFirebaseContract.Translators.ImportanceTranslator
)
    : NutshellFirebaseContract.AndroidNotificationsManager {

    override fun show(context: Context, androidNotification: NutshellFirebaseContract.AndroidNotification) {
    ...
    override fun showForeground(service: Service, androidNotification: NutshellFirebaseContract.AndroidNotification) {
