...
open class AndroidNotificationsManager(private val notificationManager: NotificationManager,
    ...
    override fun show(context: Context, androidNotification: NotificationsFrameworkContract.AndroidNotification) {
    ...
    override fun showForeground(service: Service, androidNotification: NotificationsFrameworkContract.AndroidNotification) {
